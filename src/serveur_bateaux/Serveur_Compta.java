...
import serveur.*;
import serveurSSL.ThreadServeurSSL;
...
public class Serveur_Compta extends javax.swing.JFrame implements ConsoleServeur {
    private int port_mouvements;
    private ThreadServeurSSL ts_mouvements = null;
    ...
    private void initComponents() {
        ...
        TFPort_mouvements.setText("6000");
    ...
    private void BStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BStartActionPerformed
        if(ts_mouvements == null) {
            ...
            ts_mouvements = new ThreadServeurSSL(port_mouvements, new ListeTaches(), this);
            ts_mouvements.start();
        }
    ...
    private void BStopActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BStopActionPerformed
        if(ts_mouvements != null) {
            ...
            ts_mouvements = null;
              TraceEvenements("serveur#arret#main");
        }
